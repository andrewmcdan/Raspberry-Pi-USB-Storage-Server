...
try {
    ...
    Write-Host 'Manager is listening on the configured host address and port (default 0.0.0.0:8881). Configure HTTPS using docs/manager.md before connecting Pis.'
